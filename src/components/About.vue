<template>
  <!-- ABOUT START -->
  <div class="about-area pt-80 pb-50 grey-bg" id="about">
			<div class="container">
				<div class="habout">
					<div class="row">
						...
						<div class="col-xl-6 col-lg-6 col-md-12">
							<div class="habout__img mb-30 animate__animated animate__fadeInRight animate__delay-1s">
				...
				<div class="ability mt-80">
					<div class="row">
						...
						<div class="col-sm-6 col-md-4">
							<div class="ability__single animate__animated animate__slideInUp animate__delay-1.6s mb-30">
								<h4>Vision</h4>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error sit repellendus eum quis! Quidem, iure!</p>
								<div class="ability__single-btn">
									<a href="">Read More <font-awesome-icon icon="fa-solid fa-arrow-right" /></a>
						...
						<div class="col-sm-6 col-md-4">
							<div class="ability__single animate__animated animate__slideInRight animate__delay-1.6s mb-30">
								<h4>History</h4>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Error sit repellendus eum quis! Quidem, iure!</p>
								<div class="ability__single-btn">
									<a href="">Read More <font-awesome-icon icon="fa-solid fa-arrow-right" /></a>
...
<style scoped>
/*-- About Start --*/
.about-area .habout__content h3,
.about-area .habout__content ul {
  margin-bottom: 25px;
}
.about-area .habout__content h3 li,
.about-area .habout__content ul li {
  line-height: 2;
}
.about-area .habout__img {
  position: relative;
}
.about-area .habout__content .fa-thumbs-up{
